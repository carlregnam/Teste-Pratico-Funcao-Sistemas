// 1. Criamos a memória da tela vazia
var beneficiarios = [];

$(document).ready(function () {

    // 2. O C# manda os dados para o JS através dessa variável "obj"
    if (obj) {
        ...
        // A MÁGICA AQUI: Pega a lista do C# e coloca no grid!
        if (obj.Beneficiarios != null && obj.Beneficiarios.length > 0) {
    ...
    $('#btnIncluirBeneficiario').click(function () {
        ...
        var cpfTitular = $('#CPF').val();
        if (cpf === cpfTitular) {
            ModalDialog("Atenção", "O beneficiário não pode ter o mesmo CPF do titular.");
            return;
        }
    ...
    $('#formCadastro').submit(function (e) {
        ...
        $.ajax({
            ...
            data: {
                ...
                "Beneficiarios": beneficiarios // Envia a lista para o C#
            },
            error:
                function (r) {
                    if (r.status == 400)
